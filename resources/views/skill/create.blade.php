                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="control-group col-12">
                                ...
                                <input type="text" id="type_id" class="form-control" name="type_id" placeholder="Enter the type" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="control-group col-12">
                        ...
                        <div class="row">
                            <div class="control-group col-12">
                                ...
                                <input type="text" id="level" class="form-control" name="level" placeholder="Enter the level" required>
                            </div>
                        </div>
                        <div class="row mt-2">
